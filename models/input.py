...
class Input(BaseModel):
    ...
    marital: Literal["single", "married", "divorced"] = Field(..., description="Marital status of the client")
    ...
    month: Literal["jan", "feb", "mar", "apr", "may", "jun", "jul", "aug", "sep", "oct", "nov", "dec"] = Field(..., description="Last contact month of the year")
    ...
    pdays: int = Field(..., ge=-1, description="Number of days since the client was last contacted from a previous campaign (-1 means client was not previously contacted)")
